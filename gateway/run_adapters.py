...
class GatewayAdapterLifecycleMixin:
    ...
    def _wire_adapter_handlers(
        ...
        busy_text_mode: Optional[str] = None, command_preflight=None,
    ) -> None:
        ...
        adapter.set_command_preflight_handler(command_preflight or self._primary_command_preflight())
    ...
    def _configure_profile_adapter(
        ...
        self._wire_adapter_handlers(
            ...
            command_preflight=self._make_profile_command_preflight(profile_name),
    ...
    def _primary_command_preflight(self):
        return self._make_default_profile_command_preflight() if self._multiplex_on() else self._gateway_command_preflight
