...
from gateway.platforms.event import MessageDisposition, MessageEvent, MessageType
...
class GatewayInboundMixin:
    ...
    async def _handle_message(self, event: MessageEvent) -> Optional[str]:
        ...
        if isinstance(_admitted, MessageDisposition):
            return _admitted
        ...
        if event.trusted_prompt_reply is not None:
            return await self._handle_bound_prompt_reply(event, self._session_key_for_source(source))
